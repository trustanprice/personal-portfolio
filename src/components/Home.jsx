      ...
      <section className="featured">
        ...
        <div className="project-card">
          ...
          <div className="project-info">
            ...
            <p>
              This project uses Elastic Net regression for feature reduction and
              a KNN Regressor to predict NBA team win totals based on data
              scraped and preprocessed from Basketball Reference and NBA.com.
              Built with Streamlit for the frontend and Python for the backend,
              it showcases the application of machine learning in sports
              analytics.
            </p>
            <a
        ...
        <div className="project-card">
          <img
            ...
            alt="ML Dementia Diagnosis Project"
            className="project-img"
          />
          <div className="project-info">
            <h3>ML Dementia Diagnosis Project</h3>
            <p>
              Developed and trained machine learning models, including CNNs and
              Reinforcement Learning, for early detection and classification of
              dementia using MRI scans. Integrated statistical datasets to
              improve diagnosis and enhance understanding of Alzheimer's
              disease.
            </p>
            <a
